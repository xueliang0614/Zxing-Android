    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.weixin_layout:
               // shareData(SharedManger.Plattype.QQ);
                break;
...
//                        });
    ...
    private void shareData(SharedManger.Plattype platofrm) {
        ShareData mData = new ShareData();
        Platform.ShareParams params = new Platform.ShareParams();
        params.setShareType(mShareType);
        params.setTitle("hello");
        params.setTitleUrl("http://sharesdk.cn");
        params.setSite(mShareSite);
        params.setSiteUrl(mShareSiteUrl);
        params.setText("我是分享文本");
        params.setImagePath("/sdcard/test.jpg");
        params.setUrl("http://sharesdk.cn");
        mData.type = platofrm;
        mData.params = params;
        SharedManger.getInstance().Shared(mData, mListener);
    }
}
